...
!***********************************************************************
      MODULE PRMS_MODULE
    USE ISO_FORTRAN_ENV
    USE PRMS_CONSTANTS, ONLY: MAX_DAYS_PER_YEAR, DEBUG_minimum, DEBUG_less, DEBUG_WB, DEBUG_SOLTAB, &
...
! frost_date is a pre-process module
      ...
      IF ( Print_debug==DEBUG_WB .OR. Print_debug==DEBUG_SOLTAB) CALL water_balance()
